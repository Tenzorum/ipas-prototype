      ...
      <div className="App">
        <nav style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '20%', height: '100%', backgroundColor: '#1D2533', padding: 20}}>
          <div style={{display: 'flex', width: '50%', alignItems: 'center', justifyContent: 'center'}}>
            <Link to="/home"><img style={{textDecoration: 'none' ,width: 100}} src={require('./assets/Tenz_logo.png')} alt=""/></Link>
          </div>
          ...
          <div style={{display: 'flex', width: '50%'}}>
            <Link to="/settings" style={{textDecoration: 'none' ,marginBottom: 20}}><h3 style={{fontFamily: 'Arial', fontWeight: 100, color: 'white'}}>Settings</h3></Link>
          </div>
